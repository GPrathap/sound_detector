...
datasetXLengthForConvolution =len(datasetXForConvolution1[0])
datasetYLengthForConvolution = len(datasetYForConvolution1[0])
...
for i in range(100):
    ...
    sess.run(train_op, feed_dict={xs: datasetXForConvolution1, ys: datasetYForConvolution1, keep_prob: 0.5})
    if i % 10 == 0:
        test_result = sess.run(train_op, feed_dict={xs: datasetXForConvolution1, ys: datasetYForConvolution1, keep_prob: 1})
        print('------------------')
